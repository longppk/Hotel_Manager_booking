...
const CouponCard = () => {
    ...
    const listCartPay: CartDetail[] = useSelector((state: any) => state.app.listCartPay)
    ...
    useEffect(() => {
        const calculateDiscount = () => {
            listCartPay.forEach(item => {
                const amount = item.room.price * item.quantity;
                if (amount < 1000000) {
                    setDiscount(5);
                } else {
                    setDiscount(15);
            ...
            <div className="relative w-[600px] bg-white rounded-lg shadow-lg p-4">
                <div className="flex justify-between items-center">
                    <div className="flex items-center">
                        <img
                            src="https://grandtouranehotel.com/images/logo.png"
                            alt=""
                            className="ml-8"
                        />
                    </div>
